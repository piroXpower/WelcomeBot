...
from TeamIndia.Database.mongo import db
...
@Client.on_message(filters.command("test") | filters.new_chat_members)
...
async def start(client, message):
    ...
    if len(chat_gifs) == 0:
        await message.reply_text("**Your GIF List Is Empty Please Add Some! Use /add On Replying to Some Gif**")
        return
    await message.reply_text("**GIF LIST:**")
    for i in chat_gifs:
